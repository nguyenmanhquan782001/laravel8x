                        ...
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                ...
                                <div class="form-group mb-0">
                                    <input value="{{ old("product_name", "") }}" type="text" class="form-control" name="product_name" id="inputText"
                                           placeholder="Tên sản phẩm.....">
                                </div>
                                <br>
                                @if($errors->has("product_name"))
                                 <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("product_name") }}</code></h6>
                                @endif
                    ...
                    <div class="col-lg-4">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                ...
                                <div class="form-group mb-0">
                                    <input value="{{ old("product_price" , " ") }}" type="number" class="form-control" name="product_price" id="inputText"
                                           placeholder="Giá sản phẩm.....">
                                </div>
                                <br>
                                @if($errors->has("product_price"))
                                    <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("product_price") }}</code></h6>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="white_card_body">
                                ...
                                <div class="form-group mb-0">
                                    <div class="input-group common_date_picker">
                                        <input value="{{ old("product_publish" , " ") }}" autocomplete="off" class="datepicker-here  digits"
                        ...
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                ...
                                @if($errors->has("product_quantity"))
                                      <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("product_quantity") }}</code></h6>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                ...
                                @if($errors->has("category_id"))
                                      <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("category_id") }}</code></h6>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                ...
                                @if($errors->has("product_status"))
                                     <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("product_status") }}</code></h6>
                                @endif
                        ...
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                ...
                                @if($errors->has("product_image"))
                                    <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("product_image") }}</code></h6>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="white_card_body">
                                <div class="form-group mb-0">
                                    <div id="wrapper">
                                        ...
                                        <input class="form-control" name="product_gallery[]" id="fileUpload1"  type="file" multiple />
                                    </div>
                                    <br>
                                  @if($errors->has("product_gallery"))
                                        <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first("product_gallery") }}</code></h6>
                                    @endif
                        ...
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <textarea class="form-control" rows="3" name="product_desc"
                                          id="maxlength-textarea" placeholder="Mô tả sản phẩm">{{ old("product_desc") }}</textarea>
                            </div>
                            <br>
